...
public class ShopController {
  ...
  public ResponseEntity<Void> purchaseItem(
      @AuthenticationPrincipal UserDetails userDetails, @RequestBody ShopPurchaseRequest request) {
  ...
  public ResponseEntity<Void> toggleEquipItem(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable Long inventoryId) {
    User user = getUserByUsername(userDetails.getUsername());
  ...
  public ResponseEntity<Void> equipTitle(
      @AuthenticationPrincipal UserDetails userDetails, @PathVariable Long titleId) {
    User user = getUserByUsername(userDetails.getUsername());
